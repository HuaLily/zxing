...
package com.huawenli.myzxing.camera;
...
public final class CameraManager {
    private static final int MIN_FRAME_SIZE = 300;
    ...
    public Camera open(final SurfaceHolder holder,
                       final boolean continuousAutoFocus, boolean island) throws IOException {
        // try back-facing camera
        //Log.i("hua","before open camera");
        camera = Camera.open();

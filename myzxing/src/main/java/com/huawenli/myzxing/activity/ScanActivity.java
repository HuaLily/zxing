...
import com.huawenli.myzxing.camera.CameraManager;
import com.huawenli.myzxing.view.ScannerView;
...
public class ScanActivity extends AppCompatActivity implements SurfaceHolder.Callback{
   ...
   // public static final int FromGalleryRequestCode = 1606; //从相册获取的请求码

    private static final long VIBRATE_DURATION = 50L;//抖动持续时间
   ...
   // private boolean fromGallery;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // flOverlayContainer = findViewById(R.id.fl_overlay_container);
        scannerView = findViewById(R.id.scannnerview);
        Log.i("huwenli","onCreate");
...
//        }
    ...
    public void vibrate() {
       // vibrator.vibrate(VIBRATE_DURATION); //该方法已经被弃用
    ...
    private final Runnable openRunnable = new Runnable() {
        ...
        public void run() {
            try {
                Log.i(TAG,"openCameraRunnable");
                final Camera camera = cameraManager.open(surfaceHolder,
                        !DISABLE_CONTINUOUS_AUTOFOCUS,island);
...
//        overridePendingTransition(R.anim.scanner_out_enter, 0);
    ...
    private String decodeQrCodeFromBitmap(Bitmap bmp) {
        Log.i("huwenli","decodeQrCodeFromBitmap");
